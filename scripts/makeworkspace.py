...
for i in range(len(gridx)-1):
    for j in range(len(gridy)-1):
        if gridx[i][0]<=wmass and gridx[i+1][0]>=wmass and gridy[j][0]<=pmass and gridy[j+1][0]>=pmass:
            ...
            tymin=gridy[j][0]
            tymax=gridy[j+1][0]
            fnA="../data/signal_2x2box_"+gridy[j][1]+"_"+gridx[i][1]+"_200k_events.root"
            fnB="../data/signal_2x2box_"+gridy[j][1]+"_"+gridx[i+1][1]+"_200k_events.root"
            fnC="../data/signal_2x2box_"+gridy[j+1][1]+"_"+gridx[i][1]+"_200k_events.root"
            fnD="../data/signal_2x2box_"+gridy[j+1][1]+"_"+gridx[i+1][1]+"_200k_events.root"
...
histnames=('plots/recomass_2d_variable_barrel','plots/recomass_2d_variable_endcap')
...
if __name__ == "__main__":
    ...
    for histindex,histname in enumerate(histnames):
        ...
        hA=getTH1(fnA, histname)
        hB=getTH1(fnB, histname)
        hC=getTH1(fnC, histname)
        hD=getTH1(fnD, histname)
